          ...
          {selectedInvoice ? (
            <div className="space-y-4">
              ...
              <div 
                ...
                className="printable-document bg-white text-black p-4 sm:p-8 sm:p-10 rounded-xl shadow-2xl print-surface font-sans space-y-8 min-h-[750px] overflow-x-auto"
              >
                {/* Header */}
